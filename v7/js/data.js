...
/* Car picker shelves — grouped so a pre-reader can scan by category */
const CAR_CATEGORIES = [
  { jp:'スーパーカー',    en:'Supercars',   ids:['ferrari','lambo','porsche','aston','nissan','challenger'] },
  { jp:'ごうか・でんき',  en:'Luxury & EV', ids:['benz','tesla','alphard','volvo','toyota','mazda','priusalpha'] },
  { jp:'タクシー',        en:'Taxis',       ids:['taxi','sedan','goldtaxi','robotaxi'] },
  { jp:'でんしゃ・バス',  en:'Trains & Bus',ids:['shinkansen','train','bus'] },
  { jp:'はたらくくるま',  en:'Working cars',ids:['firetruck','ambulance','police','dump'] },
  { jp:'ひみつ',          en:'Secret',      ids:['uchusen'] },
];

/* One-line hiragana fact per car — spoken aloud in the Showroom (モーターショー) */
const CAR_FACTS = {
  ferrari:'イタリアの あかい スーパーカー。とっても はやいよ！',
  lambo:'ランボルギーニは とがった かたち。かっこいいね！',
  porsche:'ポルシェは まるい ライトが めじるし',
  aston:'アストンマーティンは イギリスの こうきゅうしゃ',
  nissan:'ニッサン GT-R は にほんの はやい スポーツカー',
  challenger:'アメリカの マッスルカー。おおきい エンジン！',
  ...
  sedan:'くろい セダンの タクシー',
  goldtaxi:'ぴかぴか ゴールドの とくべつな タクシー！',
  robotaxi:'うんてんしゅが いなくても はしる みらいの くるま',
  shinkansen:'しんかんせんは とっても はやい でんしゃ！',
  train:'でんしゃは せんろの うえを はしるよ',
  bus:'バスは みんなで のれる おおきい くるま',
  firetruck:'しょうぼうしゃは かじを けしにいくよ！',
  ambulance:'きゅうきゅうしゃは びょういんへ いそぐよ',
  police:'パトカーは まちを まもるよ',
  dump:'ダンプカーは つちや いしを はこぶよ',
  uchusen:'うちゅうせんで うちゅうへ とんでいこう！',
};
function carFact(id){ return CAR_FACTS[id] || 'かっこいい くるまだね！'; }
